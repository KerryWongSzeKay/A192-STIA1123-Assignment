    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (evt.getSource()== jButton2){
            ...
            if(dialogResult ==0){
                ...
                model.removeRow(row); 
                watchList.remove(row);                              
                nameList.remove(row);
                contactList.remove(row);
                dateList.remove(row);
                genderList.remove(row);
                statusList.remove(row);
                addressList.remove(row);
                nationList.remove(row);
                ...
                try {
                    ...
                    Writer.write(String.format("=====================================================================================================================================================================================================================%n"));
                    for(int i=0;i<watchList.size();i++){
                    Writer.write(String.format("| %-19s| %-14s | %-14s| %-6s | %-15s| %-70s | %-14s | %-23s| %-15s|%n", nameList.get(i),contactList.get(i),dateList.get(i),genderList.get(i),statusList.get(i),addressList.get(i),nationList.get(i),emailList.get(i),watchList.get(i)));
                    Writer.write("|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n");                                                           
                    }                    
                    Writer.close();
