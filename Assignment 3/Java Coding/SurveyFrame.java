...
public class SurveyFrame extends javax.swing.JFrame {
    ...
    static ArrayList <String> watchList = new ArrayList<>();;
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Click Here To Go Back MENU");
      ...
      if (evt.getSource()== jButton1){
         ...
         if (count!=0){
                JOptionPane.showMessageDialog(null,"You Already Submitted , "
                        + "If want to Submit Again, "
                        + "Please Go Back MENU and Add Again,"
                        + "Thank You :) ");
            }
         if (count==0){
            int a=JOptionPane.showConfirmDialog(null," Do You Confirm To Submit ? ");
           if(a==JOptionPane.YES_OPTION){
                    ...
                    if(jComboBox5.getSelectedItem().equals(" dd (Exp : 23)")||jComboBox5.getSelectedItem().equals(" dd/MM/yyyy  (Exp : 23/05/2020)")||jComboBox5.getSelectedItem().equals(" dd MMM yyyy (Exp : 23 May 2020)")){
                        if(jComboBox6.getSelectedItem().equals(" Short-form (Exp: Sat)")||jComboBox6.getSelectedItem().equals(" Full-form (Exp: SATURDAY)")){
                            if(jCheckBox1.isSelected()&&!jCheckBox2.isSelected()&&!jCheckBox3.isSelected()&&!jCheckBox4.isSelected()&&!jCheckBox5.isSelected()&&!jCheckBox6.isSelected()&&!jCheckBox7.isSelected()&&!jCheckBox8.isSelected()){
                                ...
                                JOptionPane.showMessageDialog(null,"Submitted Successful, There Is The Survey Result ");
                                String name = nameList.get(watchList.size()-1); 
                                String contact = contactList.get(watchList.size()-1);
                                String date = dateList.get(watchList.size()-1);
                                String status = statusList.get(watchList.size()-1);
                                String gender=genderList.get(watchList.size()-1);
                                String address =addressList.get(watchList.size()-1);
                                String nationality = nationList.get(watchList.size()-1);
                                String email = emailList.get(watchList.size()-1);

                                try{ 
                                    try(FileWriter Writer = new FileWriter("/Users/User/Desktop/Customer Survey Record.txt",true)) { 
                                        Writer.write(String.format("| %-19s| %-14s | %-14s| %-6s | %-15s| %-70s | %-14s | %-23s| %-15s|%n", name,contact,date,gender,status,address,nationality,email,result));
                                        Writer.write("|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|\n");                                                           
                                        Writer.close();
                                    }
                                }
            ...
            if (jComboBox4.getSelectedItem().equals(" Digits Form")){
                if(jRadioButton1.isSelected()||jRadioButton2.isSelected()|| jRadioButton3.isSelected()){
                    if(jComboBox5.getSelectedItem().equals(" dd (Exp : 23)")||jComboBox5.getSelectedItem().equals(" dd/MM/yyyy  (Exp : 23/05/2020)")||jComboBox5.getSelectedItem().equals(" dd MMM yyyy (Exp : 23 May 2020)")){
                        if(jComboBox6.getSelectedItem().equals(" Short-form (Exp: Sat)")||jComboBox6.getSelectedItem().equals(" Full-form (Exp: SATURDAY)")){
                            if(jCheckBox1.isSelected()&&!jCheckBox2.isSelected()&&!jCheckBox3.isSelected()&&!jCheckBox4.isSelected()&&!jCheckBox5.isSelected()&&!jCheckBox6.isSelected()&&!jCheckBox7.isSelected()&&!jCheckBox8.isSelected()){
            ...
            if (jComboBox4.getSelectedItem().equals(" Analog Form / Digits Form")){
                if(jRadioButton1.isSelected()||jRadioButton2.isSelected()|| jRadioButton3.isSelected()){
                    if(jComboBox5.getSelectedItem().equals(" dd (Exp : 23)")||jComboBox5.getSelectedItem().equals(" dd/MM/yyyy  (Exp : 23/05/2020)")||jComboBox5.getSelectedItem().equals(" dd MMM yyyy (Exp : 23 May 2020)")){
                        if(jComboBox6.getSelectedItem().equals(" Short-form (Exp: Sat)")||jComboBox6.getSelectedItem().equals(" Full-form (Exp: SATURDAY)")){
                            if(jCheckBox1.isSelected()&&!jCheckBox2.isSelected()&&!jCheckBox3.isSelected()&&!jCheckBox4.isSelected()&&!jCheckBox5.isSelected()&&!jCheckBox6.isSelected()&&!jCheckBox7.isSelected()&&!jCheckBox8.isSelected()){
            ...
            if (jComboBox4.getSelectedItem().equals(" Digits Form")||jComboBox4.getSelectedItem().equals(" Analog Form / Digits Form")){
                if(jRadioButton1.isSelected()||jRadioButton2.isSelected()|| jRadioButton3.isSelected()){
                    if(jComboBox5.getSelectedItem().equals(" dd (Exp : 23)")||jComboBox5.getSelectedItem().equals(" dd/MM/yyyy  (Exp : 23/05/2020)")||jComboBox5.getSelectedItem().equals(" dd MMM yyyy (Exp : 23 May 2020)")){
                        if(jComboBox6.getSelectedItem().equals(" Short-form (Exp: Sat)")||jComboBox6.getSelectedItem().equals(" Full-form (Exp: SATURDAY)")){
                            if((jCheckBox2.isSelected()||jCheckBox3.isSelected()||jCheckBox4.isSelected())&&!jCheckBox1.isSelected()&&!jCheckBox5.isSelected()&&!jCheckBox6.isSelected()&&!jCheckBox7.isSelected()&&!jCheckBox8.isSelected()){
                                count++;
                                javax.swing.ImageIcon imageIcon=new javax.swing.ImageIcon(getClass().getResource("/Digital.jpg"));
                                Image image = imageIcon.getImage();
                                Image newimg = image.getScaledInstance(320, 356, java.awt.Image.SCALE_SMOOTH);
            ...
            if(jComboBox4.getSelectedItem().equals(" Analog Form / Digits Form")||jComboBox4.getSelectedItem().equals(" Digits Form")||jComboBox4.getSelectedItem().equals(" Analog Form ( through hands on a dial )")){
                if(jRadioButton1.isSelected()||jRadioButton2.isSelected()|| jRadioButton3.isSelected()){
                    if(jComboBox5.getSelectedItem().equals(" dd (Exp : 23)")||jComboBox5.getSelectedItem().equals(" dd/MM/yyyy  (Exp : 23/05/2020)")||jComboBox5.getSelectedItem().equals(" dd MMM yyyy (Exp : 23 May 2020)")){
                        if(jComboBox6.getSelectedItem().equals(" Short-form (Exp: Sat)")||jComboBox6.getSelectedItem().equals(" Full-form (Exp: SATURDAY)")){
                            if((jCheckBox5.isSelected()||jCheckBox6.isSelected()||jCheckBox7.isSelected()||jCheckBox8.isSelected())&&!jCheckBox1.isSelected()&&!jCheckBox2.isSelected()&&!jCheckBox3.isSelected()&&!jCheckBox4.isSelected()){
                                count++;
                                javax.swing.ImageIcon imageIcon=new javax.swing.ImageIcon(getClass().getResource("/Smart.jpg"));
                                Image image = imageIcon.getImage();
                                Image newimg = image.getScaledInstance(255, 356, java.awt.Image.SCALE_SMOOTH);
